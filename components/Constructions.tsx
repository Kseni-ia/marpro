...
const Constructions: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-maintenance-dark border-2 border-gray-dark-border rounded-[15px] sm:rounded-[20px] md:rounded-[25px] p-6 sm:p-8 md:p-12 text-center mb-6 sm:mb-8 md:mb-10 shadow-[0_15px_40px_rgba(0,0,0,0.3)] relative overflow-hidden rotating-bg">
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-4">
