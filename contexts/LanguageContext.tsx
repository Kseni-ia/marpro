...
const translations = {
  en: {
    ...
    'order.containerVolume': 'Container Volume',
    'order.wasteType': 'Waste Type',
    'order.selectWasteType': 'Select waste type',
    'order.estimatedPrice': 'Estimated Price',
    ...
    'admin.containerImage': 'Container Image',
  ...
  cs: {
    ...
    'order.containerVolume': 'Objem kontejneru',
    'order.wasteType': 'Typ odpadu',
    'order.selectWasteType': 'Vyberte typ odpadu',
    'order.estimatedPrice': 'Orientační cena',
    ...
    'admin.containerImage': 'Ilustrace kontejneru',
  ...
  ru: {
    ...
    'order.containerVolume': 'Объем контейнера',
    'order.wasteType': 'Тип отходов',
    'order.selectWasteType': 'Выберите тип отходов',
    'order.estimatedPrice': 'Ориентировочная цена',
    ...
    'admin.containerImage': 'Изображение контейнера',
