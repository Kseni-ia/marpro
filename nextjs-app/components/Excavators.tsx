    ...
    <div className="bg-gradient-card border-2 border-gray-e0e rounded-[15px] sm:rounded-[20px] p-4 sm:p-5 md:p-7 transition-all duration-[400ms] shadow-[0_8px_25px_rgba(0,0,0,0.06)] relative overflow-hidden group hover:-translate-y-2 hover:scale-[1.03] hover:shadow-[0_15px_35px_rgba(0,0,0,0.1)] hover:bg-gradient-card-hover hover:border-gray-ccc card-shine">
      ...
      <div className="flex items-start justify-between flex-col sm:flex-row gap-3 sm:gap-0">
        <div>
          <div className="flex items-baseline gap-1 leading-none">
            <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-333">{model}</span>
          </div>
          <span className="text-gray-666 mt-1 block tracking-wide text-sm sm:text-base">{type}</span>
        </div>
        <div className="text-left sm:text-right">
          ...
          <div className="text-gray-555 text-xs sm:text-sm mt-2">{specs.weight}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-3 sm:mb-4">
        <div className="text-center">
          <div className="text-xs sm:text-sm text-gray-555">Bucket</div>
          <div className="text-sm sm:text-base md:text-lg font-semibold text-gray-333">{specs.bucketCapacity}</div>
        </div>
        <div className="text-center">
          <div className="text-xs sm:text-sm text-gray-555">Max Reach</div>
          <div className="text-sm sm:text-base md:text-lg font-semibold text-gray-333">{specs.maxReach}</div>
        </div>
        <div className="text-center">
          <div className="text-xs sm:text-sm text-gray-555">Weight</div>
          <div className="text-sm sm:text-base md:text-lg font-semibold text-gray-333">{specs.weight}</div>
        </div>
      </div>
...
const Excavators: React.FC = () => {
  return (
    <div className="p-4 sm:p-6 md:p-10 animate-fade-in min-h-[calc(100vh-100px)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-4">
        <ExcavatorCard
          model="TB145"
          type="Mini Excavator"
