    ...
    <>
      ...
      >
        ...
        <div className="text-left">
          <span className="text-sm font-semibold block">{t('admin.addNewExcavator')}</span>
          <span className="text-xs text-gray-500 group-hover:text-gray-400">{t('admin.addNewExcavatorDesc')}</span>
        </div>
      </button>
    </>
  )
